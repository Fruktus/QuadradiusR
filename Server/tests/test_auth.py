...
from quadradiusr_server.auth import hash_password, is_password_valid, Auth
...
class AuthTest(IsolatedAsyncioTestCase):
    async def test_hashing(self):
        ...
        self.assertTrue(is_password_valid(b'asdf', h))
        self.assertFalse(is_password_valid(b'asdf2', h))
